...
public class Naive
{
    ...
    public Naive(string Age, string Sex, string Chest, string Bp, string Chol, string FBloodSuger, string Resting, string MaxHeartRate, string Angina, string Oldpeak, string Slope, string Vessels, string Thal)
    {
